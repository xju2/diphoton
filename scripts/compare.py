...
def test3():
    ...
    for hist,x_title,y_title,is_log in hist_names:
        ...
        if "mass_etabins" in hist:
            ...
            h2_all.Scale(h1_all.Integral()/h2_all.Integral())
            h3_all.Scale(h1_all.Integral()/h3_all.Integral())
            list_all = ROOT.TList()
            list_all.Add(h1_all)
            list_all.Add(h2_all)
            list_all.Add(h3_all)
            ...
            h2_cc1.Scale(h1_cc1.Integral()/h2_cc1.Integral())
            h3_cc1.Scale(h1_cc1.Integral()/h3_cc1.Integral())
            list_cc1 = ROOT.TList()
            list_cc1.Add(h1_cc1)
            list_cc1.Add(h2_cc1)
            list_cc1.Add(h3_cc1)
            ...
            h2_other1.Scale(h1_other1.Integral()/h2_other1.Integral())
            h3_other1.Scale(h1_other1.Integral()/h3_other1.Integral())
            ...
            h2_cc2.Scale(h1_cc2.Integral()/h2_cc2.Integral())
            h3_cc2.Scale(h1_cc2.Integral()/h3_cc2.Integral())
            list_cc2 = ROOT.TList()
            list_cc2.Add(h1_cc2)
            list_cc2.Add(h2_cc2)
            list_cc2.Add(h3_cc2)
            ...
            h2_other2.Scale(h1_other2.Integral()/h2_other2.Integral())
            h3_other2.Scale(h1_other2.Integral()/h3_other2.Integral())
            ...
            if not "eta" in h1.GetName():
                ...
                h2.Rebin(10)
                h3.Rebin(10)
                data_yield = h1.Integral()
                h2.Scale(data_yield/h2.Integral())
                h3.Scale(data_yield/h3.Integral())
            else:
